...
class AudioFrame {
 public:
  ...
  VADActivity vad_activity_ = kVadUnknown;
    ...
    uint32_t    client_ssrcs[16];
    uint8_t     client_ssrcs_num;
...
inline void AudioFrame::CopyFrom(const AudioFrame& src) {
  ...
  memcpy(data_, src.data_, sizeof(int16_t) * length);
    source_ssrc = src.source_ssrc;
    client_ssrcs_num = src.client_ssrcs_num;
    memcpy(client_ssrcs, src.client_ssrcs, sizeof(client_ssrcs));
