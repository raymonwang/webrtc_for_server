...
public:
    ...
    virtual int32_t PreProcessTransmitMix() = 0;
    
    // mixaudio for special channel
    virtual int32_t ProcessForChannel(const int32_t channelID, bool mix_all = false) = 0;
    
    virtual void ClearTransmitMixCache() = 0;
