...
class WebRtcVoiceCodecs final {
 ...
 private:
  ...
  static const CodecPref kCodecPrefs[15];
...
const WebRtcVoiceCodecs::CodecPref WebRtcVoiceCodecs::kCodecPrefs[15] = {
    {kOpusCodecName, 48000, 2, 121, true, {10, 20, 40, 60}, kOpusMaxBitrateBps},
    {kOpusCodecName, 16000, 2, 120, true, {10, 20, 40, 60}, kOpusMaxBitrateBps},
